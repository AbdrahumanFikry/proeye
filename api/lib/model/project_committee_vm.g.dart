...
part of 'project_committee_vm.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<ProjectCommitteeVM> _$projectCommitteeVMSerializer =
    new _$ProjectCommitteeVMSerializer();

class _$ProjectCommitteeVMSerializer
    implements StructuredSerializer<ProjectCommitteeVM> {
  @override
  final Iterable<Type> types = const [ProjectCommitteeVM, _$ProjectCommitteeVM];
  @override
  final String wireName = 'ProjectCommitteeVM';

  @override
  Iterable<Object> serialize(Serializers serializers, ProjectCommitteeVM object,
    ...
    if (value != null) {
      result
        ...
        ..add(serializers.serialize(value,
            specifiedType: const FullType(
                BuiltList, const [const FullType(ProjectTeamVM)])));
    }
    return result;
  }

  @override
  ProjectCommitteeVM deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new ProjectCommitteeVMBuilder();
...
class _$ProjectCommitteeVM extends ProjectCommitteeVM {
  @override
  final bool isDone;
  @override
  final bool isLate;
  ...
  @override
  final BuiltList<ProjectTeamVM> teams;

  factory _$ProjectCommitteeVM(
          [void Function(ProjectCommitteeVMBuilder) updates]) =>
      (new ProjectCommitteeVMBuilder()..update(updates)).build();

  _$ProjectCommitteeVM._(
      {this.isDone,
      this.isLate,
      this.plannedStart,
  ...
  @override
  ProjectCommitteeVM rebuild(
          void Function(ProjectCommitteeVMBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ProjectCommitteeVMBuilder toBuilder() =>
      new ProjectCommitteeVMBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ProjectCommitteeVM &&
        isDone == other.isDone &&
        isLate == other.isLate &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('ProjectCommitteeVM')
          ..add('isDone', isDone)
          ..add('isLate', isLate)
...
class ProjectCommitteeVMBuilder
    implements Builder<ProjectCommitteeVM, ProjectCommitteeVMBuilder> {
  _$ProjectCommitteeVM _$v;
  ...
  ListBuilder<ProjectTeamVM> _teams;
  ListBuilder<ProjectTeamVM> get teams =>
      _$this._teams ??= new ListBuilder<ProjectTeamVM>();
  set teams(ListBuilder<ProjectTeamVM> teams) => _$this._teams = teams;

  ProjectCommitteeVMBuilder() {
    ProjectCommitteeVM._initializeBuilder(this);
  }

  ProjectCommitteeVMBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _isDone = $v.isDone;
      _isLate = $v.isLate;
  ...
  @override
  void replace(ProjectCommitteeVM other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ProjectCommitteeVM;
  }

  @override
  void update(void Function(ProjectCommitteeVMBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$ProjectCommitteeVM build() {
    _$ProjectCommitteeVM _$result;
    try {
      _$result = _$v ??
          new _$ProjectCommitteeVM._(
              isDone: isDone,
              isLate: isLate,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'ProjectCommitteeVM', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
